...
public class MemberController {
    ...
    @PostMapping("/notify")
    public org.springframework.http.ResponseEntity<String> notifyMe(
            @RequestHeader("X-User-Id") String userIdStr,
    ...
    public org.springframework.http.ResponseEntity<Boolean> checkNotifyStatus(
            @RequestHeader("X-User-Id") String userIdStr,
        ...
        return org.springframework.http.ResponseEntity.ok(isPending);
    }
